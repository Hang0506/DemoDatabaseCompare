...
public static class DemoDatabaseCompareEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE DemoDatabaseCompareModuleExtensionConfigurator CLASS (in the Domain.Shared project)
