...
public class DemoDatabaseCompareDbContext :
    AbpDbContext<DemoDatabaseCompareDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public DemoDatabaseCompareDbContext(DbContextOptions<DemoDatabaseCompareDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(DemoDatabaseCompareConsts.DbTablePrefix + "Students", DemoDatabaseCompareConsts.DbSchema);
            ...
            b.Property(x => x.Grade).IsRequired().HasMaxLength(32);
